...
//      Button startBatteryTest = (Button) v.findViewById(R.id.startBatteryTest);
//      startBatteryTest.setOnClickListener(new View.OnClickListener(){
//
//          @Override
//          public void onClick(View v) {
//              AppendLog.Log("Battery Test started!");
//              Log.v("Battery Test started!","Battery Test started!");
//              //Toast.makeText(getContext(),"Battery Test started!",Toast.LENGTH_SHORT).show();
//          }
//      });
      //return v;
  ...
  public void onActivityCreated(final Bundle savedInstanceState) {
    super.onActivityCreated(savedInstanceState);
        ...
        public void onClick(View v) {
            ...
            offload = !offload;
            if(offload){
              changeMode.setText("click to run locally");
              Toast.makeText(getContext(),"Offloading!",Toast.LENGTH_SHORT).show();
            }else{
              changeMode.setText("click to offload");
              Toast.makeText(getContext(),"Running locally!",Toast.LENGTH_SHORT).show();
            }
            Log.v("Battery Test started!","Battery Test started!");
...
//                          , width, height, largest);
          ...
          Log.v("psizeProcessingTimeMs","" + height +"," + width);
